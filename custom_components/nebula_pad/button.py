...
class NebulaPadBaseButton(ButtonEntity):
    """Base class for Nebula Pad button entities."""
...
class AutoHomeXYButton(NebulaPadBaseButton):
    ...
    def __init__(self, coordinator: NebulaPadCoordinator) -> None:
        ...
        self._attr_unique_id = "nebula_pad_autohome_xy"
...
class AutoHomeZButton(NebulaPadBaseButton):
    ...
    def __init__(self, coordinator: NebulaPadCoordinator) -> None:
        """Initialize the button entity."""
        super().__init__(coordinator)
        self._attr_unique_id = "nebula_pad_autohome_z"
